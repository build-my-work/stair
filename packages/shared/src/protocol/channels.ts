...
export const RPC_CHANNELS = {
  ...
  sessions: {
    ...
    CREATE_SIDE_CHAT: 'sessions:createSideChat',
  ...
  browserPane: {
    ...
    UPDATE_BOUNDS: 'browser-pane:update-bounds',
    ...
    REVEAL_SELECTION: 'browser-pane:reveal-selection',
    ...
    SELECTION_ASK: 'browser-pane:selection-ask',
  },
  automations: {
    GET: 'automations:get',
  ...
  projects: {
    ...
    LIST_WORKING_DIRECTORY_ENTRIES: 'projects:listWorkingDirectoryEntries',
    READ_WORKING_DIRECTORY_TEXT: 'projects:readWorkingDirectoryText',
    READ_WORKING_DIRECTORY_BINARY: 'projects:readWorkingDirectoryBinary',
    READ_WORKING_DIRECTORY_DATA_URL: 'projects:readWorkingDirectoryDataUrl',
    OPEN_WORKING_DIRECTORY_FILE: 'projects:openWorkingDirectoryFile',
    PARSE_WORKING_DIRECTORY_TEXTBOOK: 'projects:parseWorkingDirectoryTextbook',
    LIST_ARTIFACTS: 'projects:listArtifacts',
    GET_ARTIFACT: 'projects:getArtifact',
    SAVE_ARTIFACT: 'projects:saveArtifact',
    DELETE_ARTIFACT: 'projects:deleteArtifact',
    LIST_WORKING_FILE_EPUB_HIGHLIGHTS: 'projects:listWorkingFileEpubHighlights',
    SAVE_WORKING_FILE_EPUB_HIGHLIGHT: 'projects:saveWorkingFileEpubHighlight',
    DELETE_WORKING_FILE_EPUB_HIGHLIGHT: 'projects:deleteWorkingFileEpubHighlight',
    EXPORT_WORKING_FILE_EPUB_HIGHLIGHTS: 'projects:exportWorkingFileEpubHighlights',
