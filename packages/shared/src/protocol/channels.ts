...
export const RPC_CHANNELS = {
  ...
  projects: {
    ...
    IMPORT_TEXTBOOK: 'projects:importTextbook',
    PARSE_TEXTBOOK_ASSET: 'projects:parseTextbookAsset',
    LIST_EPUB_HIGHLIGHTS: 'projects:listEpubHighlights',
    SAVE_EPUB_HIGHLIGHT: 'projects:saveEpubHighlight',
    DELETE_EPUB_HIGHLIGHT: 'projects:deleteEpubHighlight',
    EXPORT_EPUB_HIGHLIGHTS: 'projects:exportEpubHighlights',
