 ...
 * - Location: Default product workspace directory or Custom
 */
export function AddWorkspaceStep_CreateNew({
  ...
  // Get the active product configuration directory on mount
  useEffect(() => {
      ...
      <div className="mt-6 w-full space-y-6">
        ...
        <div className="space-y-3">
          ...
          <AddWorkspace_RadioOption
            ...
            subtitle={t("workspace.underDefaultFolder", { path: defaultBasePath ?? '' })}
          />
