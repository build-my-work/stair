...
const EXPECTED_CHANNELS: string[] = [
  ...
  'projects:create',
  'projects:delete',
  'projects:deleteArtifact',
  'projects:deleteWorkingFileEpubHighlight',
  'projects:exportWorkingFileEpubHighlights',
  'projects:get',
  'projects:getArtifact',
  'projects:getOne',
  'projects:listArtifacts',
  'projects:listWorkingDirectoryEntries',
  'projects:listWorkingFileEpubHighlights',
  'projects:openWorkingDirectoryFile',
  'projects:parseWorkingDirectoryTextbook',
  'projects:readWorkingDirectoryBinary',
  'projects:readWorkingDirectoryDataUrl',
  'projects:readWorkingDirectoryText',
  'projects:saveArtifact',
  'projects:saveWorkingFileEpubHighlight',
  'projects:update',
  'releaseNotes:get',
