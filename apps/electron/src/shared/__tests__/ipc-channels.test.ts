...
const EXPECTED_CHANNELS: string[] = [
  ...
  'projects:deleteEpubHighlight',
  'projects:exportEpubHighlights',
  'projects:get',
  'projects:getOne',
  'projects:importTextbook',
  'projects:listAssets',
  'projects:listEpubHighlights',
  'projects:parseTextbookAsset',
  'projects:saveEpubHighlight',
  'projects:update',
