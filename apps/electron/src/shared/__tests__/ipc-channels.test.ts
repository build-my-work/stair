...
const EXPECTED_CHANNELS: string[] = [
  ...
  'browser-pane:attach-surface',
  'browser-pane:click',
  'browser-pane:close-panel-requested',
  'browser-pane:create',
  'browser-pane:destroy',
  'browser-pane:detach-surface',
  ...
  'browser-pane:present-requested',
  'browser-pane:reload',
  'browser-pane:removed',
  'browser-pane:reveal-selection',
  'browser-pane:screenshot',
  'browser-pane:scroll',
  'browser-pane:select',
  'browser-pane:selection-action',
  'browser-pane:snapshot',
  'browser-pane:state-changed',
  'browser-pane:stop',
  'browser-pane:update-surface',
  ...
  'tools:getWebLinkOpenTarget',
  'tools:setBrowserToolEnabled',
  'tools:setWebLinkOpenTarget',
  'transfer:abort',
  'transfer:chunk',
  'transfer:commit',
  'transfer:start',
