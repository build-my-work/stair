...
export const CHANNEL_MAP = {
  ...
  createSideChat: invoke(RPC_CHANNELS.sessions.CREATE_SIDE_CHAT),
  ...
  'browserPane.attach': invoke(RPC_CHANNELS.browserPane.ATTACH),
  'browserPane.detach': invoke(RPC_CHANNELS.browserPane.DETACH),
  'browserPane.updateBounds': invoke(RPC_CHANNELS.browserPane.UPDATE_BOUNDS),
  ...
  'browserPane.onSelectionAsk': listener(RPC_CHANNELS.browserPane.SELECTION_ASK),
  ...
  listWorkingDirectoryEntries: invoke(RPC_CHANNELS.projects.LIST_WORKING_DIRECTORY_ENTRIES),
  readWorkingDirectoryText: invoke(RPC_CHANNELS.projects.READ_WORKING_DIRECTORY_TEXT),
  readWorkingDirectoryBinary: invoke(RPC_CHANNELS.projects.READ_WORKING_DIRECTORY_BINARY),
  readWorkingDirectoryDataUrl: invoke(RPC_CHANNELS.projects.READ_WORKING_DIRECTORY_DATA_URL),
  openWorkingDirectoryFile: invoke(RPC_CHANNELS.projects.OPEN_WORKING_DIRECTORY_FILE),
  parseWorkingDirectoryTextbook: invoke(RPC_CHANNELS.projects.PARSE_WORKING_DIRECTORY_TEXTBOOK),
  listProjectArtifacts: invoke(RPC_CHANNELS.projects.LIST_ARTIFACTS),
  getProjectArtifact: invoke(RPC_CHANNELS.projects.GET_ARTIFACT),
  saveProjectArtifact: invoke(RPC_CHANNELS.projects.SAVE_ARTIFACT),
  deleteProjectArtifact: invoke(RPC_CHANNELS.projects.DELETE_ARTIFACT),
  listWorkingFileEpubHighlights: invoke(RPC_CHANNELS.projects.LIST_WORKING_FILE_EPUB_HIGHLIGHTS),
  saveWorkingFileEpubHighlight: invoke(RPC_CHANNELS.projects.SAVE_WORKING_FILE_EPUB_HIGHLIGHT),
  deleteWorkingFileEpubHighlight: invoke(RPC_CHANNELS.projects.DELETE_WORKING_FILE_EPUB_HIGHLIGHT),
  exportWorkingFileEpubHighlights: invoke(RPC_CHANNELS.projects.EXPORT_WORKING_FILE_EPUB_HIGHLIGHTS),
