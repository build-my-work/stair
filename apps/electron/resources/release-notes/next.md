...
- **Workspace browser bookmarks** — Save the current web page from the built-in browser toolbar and reopen or remove saved pages from a Workspace-scoped bookmarks list.
